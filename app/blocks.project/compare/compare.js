...
(function($) {
  ...
  $.fn.readmore.defaults = {
    ...
    textOpen: 'Весь текст',     // string : текст ссылки в свернутом состоянии
...
$(function() {
  ...
  /*=== STICK CARD START ===*/
  /*$('.compare__content').waypoint(function() {

    $('.compare__top').addClass('compare__top_fixed');
  ...
  /*=== ARROWS START ===*/
  /*let arrowLeft = $('.compare__left');
  let arrowRight = $('.compare__right');

  let compareWidth = $('.compare').width();

  let itemsWidth = 0;
  $('.compare__top-item').each(function() {
    itemsWidth += $(this).outerWidth();
  });
  //console.log(Math.ceil(itemsWidth - 20));

  let getPosition = function () {
    return $('.compare__top').scrollLeft();
  };
  arrowRight.click(function() {
    let rightSteps = 0;
    $('.compare__inner').animate({
      scrollLeft: rightSteps + 150
    });
    console.log($('.compare__top').scrollLeft());
  })*/
  /*=== ARROWS END ===*/
